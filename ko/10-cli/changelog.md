...
changelog는 버전 단위의 정확한 변화 확인용입니다. 모든 수정이 아니라 "무엇이 내 작업 방식을 바꾸는가"를 보고 싶다면 [WHATS-NEW.md](/Users/jhj/Desktop/personal/claude-code-guide-book/WHATS-NEW.md) 또는 공식 weekly digest가 더 적합합니다.
