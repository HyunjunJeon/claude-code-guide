...
- **[Checkpoints와 되감기](08-checkpoints.md)** - 대화 상태 저장 및 복원
- **[Slash Commands](01-slash-commands.md)** - 커스텀 slash command 생성
- **[Skills](03-skills.md)** - 재사용 가능한 자율 기능
- **[Subagents](04-subagents.md)** - 위임된 작업 실행
- **[Plugins](07-plugins.md)** - 번들형 확장 패키지
- **[고급 기능](09-advanced-features.md)** - 고급 Claude Code 기능 탐색
...
- **[메모리 가이드](02-memory.md)** - 영구 컨텍스트 설정
