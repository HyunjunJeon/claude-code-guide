...
[[TIP("참고")]]
사용자 정의 slash command는 skill로 통합되었습니다. `.claude/commands/`에 있는 파일은 여전히 작동하지만, skill(`.claude/skills/`)이 현재 권장 방식입니다. 두 가지 모두 `/command-name` 단축 명령을 생성합니다. 전체 레퍼런스는 [Skill 가이드](03-skills.md)를 참조하십시오.
[[/TIP]]
...
**스크린샷:**
![/pr](../assets/pr-slash-command.png)
...
- **[Skill](03-skills.md)** - Skill 전체 레퍼런스 (자동 호출 기능)
- **[Memory](02-memory.md)** - CLAUDE.md를 사용한 영구 컨텍스트
- **[Subagent](04-subagents.md)** - 위임된 AI agent
- **[Plugin](07-plugins.md)** - 번들 명령 컬렉션
