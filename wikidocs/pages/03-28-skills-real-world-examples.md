이 문서는 코드 리뷰·시각화·배포·브랜드 보이스·CLAUDE.md 생성·리팩토링 등 다양한 영역에서 스킬이 어떻게 쓰이는지 6가지 예시로 보여줍니다.
처음 스킬을 설계할 때 "다른 사람들은 SKILL.md에 뭐를 어떻게 적었지?"라는 영감을 얻기 좋습니다.
각 예시는 디렉토리 구조·frontmatter·본문을 모두 포함하므로 그대로 복사해 시작점으로 쓸 수 있습니다.
