...
전체 카탈로그는 [references/code-smells.md](03-18-refactor-references-code-smells.md)를 참조하십시오.
...
전체 목록은 [references/refactoring-catalog.md](03-19-refactor-references-refactoring-catalog.md)를 참조하십시오.
...
[templates/refactoring-plan.md](03-20-refactor-templates-refactoring-plan.md)의 템플릿을 사용합니다.
...
- [코드 스멜 카탈로그](03-18-refactor-references-code-smells.md) - 코드 스멜 전체 목록
- [리팩토링 카탈로그](03-19-refactor-references-refactoring-catalog.md) - 리팩토링 기법
- [리팩토링 계획 템플릿](03-20-refactor-templates-refactoring-plan.md) - 계획 템플릿
