...
- [Changelog](https://wikidocs.net/345359)
- [Interactive Mode](https://wikidocs.net/345355)
- [Environment Variables](https://wikidocs.net/345701)
...
| `claude mcp` | MCP 서버 구성 | [MCP 문서](https://wikidocs.net/345445) 참조 |
...
- **[Slash Command](https://wikidocs.net/345351)** - Claude 내 사용자 정의 단축키
- **[메모리 가이드](https://wikidocs.net/345360)** - CLAUDE.md를 통한 영구 컨텍스트
- **[MCP 프로토콜](https://wikidocs.net/345445)** - 외부 도구 통합
- **[고급 기능](https://wikidocs.net/345672)** - Plan mode, extended thinking
