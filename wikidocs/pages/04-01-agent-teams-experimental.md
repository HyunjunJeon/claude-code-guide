...
입문 수준의 개요는 [agent-teams.md](https://wikidocs.net/345624)를 참고하고, 본 문서는 활성화·표시 모드·작업 의존성·hook까지 상세 설정에 집중합니다.
...
Agent Teams는 세 가지 추가 [hook 이벤트](https://wikidocs.net/344613)를 도입합니다. 종료 코드 2는 해당 동작을 차단합니다:
