...
- [ ] **T-069** — Create a committed official Claude Code feature-doc inventory + coverage matrix
...
- [ ] **T-070** — Make section-level parity a first-class artifact for large doc families
...
- [ ] **T-072** — Convert parity gaps into owned backlog items
...
- [ ] **T-073** — Align checkpointing language with official restore-vs-summarize semantics
...
- [ ] **T-074** — Add missing hooks operational UX coverage
...
- [ ] **T-075** — Deepen hooks reference coverage for long-tail events
...
- [ ] **T-076** — Add async/background hook execution guidance
...
- [ ] **T-080** — Expand plugin technical reference coverage
...
- [ ] **T-081** — Expand plugin lifecycle and distribution edge cases
...
- [ ] **T-082** — Add a dedicated `Output styles` guide
...
- [ ] **T-083** — Add a dedicated `Fullscreen rendering` guide
...
- [ ] **T-084** — Add a dedicated `Terminal configuration` guide
...
- [ ] **T-085** — Expand configuration into a real settings-system guide
...
- [ ] **T-086** — Consolidate interactive-mode reference coverage
...
- [ ] **T-087** — Add a true `Channels reference` implementation guide
...
- [ ] **T-088** — Add missing platform/integration feature coverage
...
- [ ] **T-089** — Refresh the page-level and section-level parity audits against the current Claude Code version
...
- [ ] **T-090** — Add a parity gate to version verification
  ...
  - Link version verification output back to the parity artifacts

- [ ] **T-091** — Update public wording based on parity result
...
- [ ] **T-092** — Re-run parity audit after every Claude Code release
...
- [ ] **T-093** — Maintain section-level parity artifacts as a permanent system
